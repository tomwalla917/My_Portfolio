          ...
          <div className="box">
            <div className="projectCard">
              ...
              <div className="prjDesc">
                ...
                <p>
                  A geospatial search tool that allows users to input latitude,
                  longitude, and search radius to find all filed and completed
                  FAA studies near their project location. Built with
                  JavaScript, HTML, CSS, SQL, C#, and ASP.NET. Contact me to
                  request an access key or start a free trial.
                </p>
            ...
            <div className="projectCard">
              ...
              <div className="prjDesc">
                ...
                <p>
                  A turn-based football game where you control the final
                  possession of the game. Follow the prompts to make strategic
                  plays and score the winning touchdown. Built with JavaScript,
                  HTML, and CSS.
                </p>
                <a
            ...
            <div className="projectCard">
              ...
              <div className="prjDesc">
                ...
                <p>
                  A front-end dragon creator that lets you design custom dragons
                  by selecting their type, age, element, and special abilities.
            ...
            <div className="projectCard">
              ...
              <div className="prjDesc">
                ...
                <p>
                  An interactive character creation tool where you can build
                  characters and manage their personal inventories. Built with
